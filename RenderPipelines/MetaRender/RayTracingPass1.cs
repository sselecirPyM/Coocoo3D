...
public class RayTracingPass1
{
    ...
    public IEnumerable<MeshRenderable1> meshRenderables;
    ...
    public void Execute(RenderHelper renderHelper, bool directionalLight)
    {
        ...
        tpas.instances = new();
        foreach (var renderable in meshRenderables)
        {
            var material = renderable.properties;
