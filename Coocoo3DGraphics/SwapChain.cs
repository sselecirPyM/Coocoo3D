...
public class SwapChain : IDisposable
{
    ...
    public void Initialize(GraphicsDevice device, IntPtr hwnd, SwapChainDescription1 swapChainDescription1)
    {
        this.format = swapChainDescription1.Format;
        this.hwnd = hwnd;
        this.width = swapChainDescription1.Width;
        this.height = swapChainDescription1.Height;
        this.device = device;
        InternalInit(swapChainDescription1);
    }

    private void InternalInit(SwapChainDescription1 swapChainDescription1)
    {
